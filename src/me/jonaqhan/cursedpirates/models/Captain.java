...
public class Captain extends EntityVillager {

	private static Field attributeField;

	public Captain(Location loc) {
		super(EntityTypes.VILLAGER, ((CraftWorld) loc.getWorld()).getHandle(), VillagerType.JUNGLE);

		this.setSlot(EnumItemSlot.HEAD, CraftItemStack.asNMSCopy(createSkull(
				"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzc4ODI4YWMzYTYxZDg3MTJkZTUyNzFiYjM1YzRjNzE0NmE2YjM2YzZiNGU1NzZmNWViOGQxNzhkYTdkZmQzNCJ9fX0=")),
				true);

		this.setCustomName(new ChatComponentText(Chat.color("&c&lCaptain")));
	...
	public void initPathfinder() {
		...
		this.goalSelector.a(2, new PathfinderGoalMeleeAttack(this, 0.60D, true));
