...
public class CabinBoy extends EntityVillager {

	private static Field attributeField;

	public CabinBoy(Location loc) {
		super(EntityTypes.VILLAGER, ((CraftWorld) loc.getWorld()).getHandle(), VillagerType.SNOW);
		...
		this.setCustomName(new ChatComponentText(Chat.color("&9Cabin Boy")));
	...
	public void initPathfinder() {
		...
		this.goalSelector.a(2, new PathfinderGoalMeleeAttack(this, 2.0D, true));
